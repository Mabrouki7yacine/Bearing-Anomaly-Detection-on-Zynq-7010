...
user.org:hls:fft_energy_axis:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: fft_energy_axis_0, and set properties
  set fft_energy_axis_0 [ create_bd_cell -type ip -vlnv user.org:hls:fft_energy_axis:1.0 fft_energy_axis_0 ]
  ...
  connect_bd_intf_net -intf_net fft_energy_axis_0_m_axis [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins fft_energy_axis_0/m_axis]
